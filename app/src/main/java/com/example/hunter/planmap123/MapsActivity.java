...
Iterator itr,itr1;
    ...
    {
        Collections.sort(drenched,Places.StuLatitudeComparator);
        LatSort.addAll(drenched);
        Collections.sort(drenched,Places.StuLongitudeComparator);
        LongSort.addAll(drenched);
